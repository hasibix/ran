...
* the relevant app definition file (remove anything sensitive)  
...
* describe how you think ran should behave  
...
1. make sure ran builds and your change works  
...
we want ran to be friendly and respectful. be patient if replies take some time, and keep discussion focused and polite — everyone’s here to help.  
